        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-gradient-to-r from-green-600 to-green-600
              ...
              <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                {/* change the template and the accent color */}
             ...
             to-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 
            ...
            <div className="relative w-full">
                ...
                items-center justify-end gap-2">
                  {resumeData.public && (
                    ...
                    gap-2 text-xs bg-gradient-to-br from-blue-100
                    to-blue-200 text-blue-600 rounded-lg ring-blue-300
                  ...
                  className="flex items-center p-2 px-4 
                    gap-2 text-xs bg-gradient-to-br from-purple-100
                    to-purple-200 text-purple-600 rounded-lg ring-purple-300
                    hover:ring transition-colors">
                    {
                  ...
                  <button
                   ...
                   className="flex items-center p-2 px-4 
                    gap-2 text-xs bg-gradient-to-br from-green-100
                    to-green-200 text-green-600 rounded-lg ring-green-300
                    hover:ring transition-colors">
